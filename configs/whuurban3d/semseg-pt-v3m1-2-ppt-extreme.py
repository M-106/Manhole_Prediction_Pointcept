...
# trainer
train = dict(
    type="DefaultTrainer",  # Changed from MultiDatasetTrainer to DefaultTrainer for single dataset
)
...
model = dict(
    ...
    backbone=dict(
        ...
        pdnorm_affine=True,
        pdnorm_conditions=("S3DIS",),  # Isolated to S3DIS
    ),
    criteria=[
    ...
    conditions=("S3DIS",),  # Isolated to S3DIS
    template="[x]",
    clip_model="ViT-B/16",
    # fmt: off
    class_name=(
