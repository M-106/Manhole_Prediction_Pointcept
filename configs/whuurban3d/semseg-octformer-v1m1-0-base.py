...
model = dict(
    ...
    backbone=dict(
        type="OctFormer-v1m1",
        in_channels=10,  # 3 XYZ + 3 RGB + 3 Normals + 1 Displacement
...
data = dict(
    ...
    train=dict(
        ...
        transform=[
            ...
            dict(
                type="GridSample",
                grid_size=0.05,  # Upgraded voxel grid for MLS outdoor spatial scale
                hash_type="fnv",
                mode="train",
    ...
    val=dict(
        ...
        transform=[
            ...
            dict(
                type="GridSample",
                grid_size=0.05,  # Match train voxel size
                hash_type="fnv",
                mode="train",
                return_min_coord=True,
                return_displacement=True,
    ...
    test=dict(
        ...
        test_cfg=dict(
            voxelize=dict(
                type="GridSample",
                grid_size=0.05,  # Match target test inference voxel size
                hash_type="fnv",
                mode="test",
                return_displacement=True,
                project_displacement=True,
