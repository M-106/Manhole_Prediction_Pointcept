...
data = dict(
    ...
    train=dict(
        ...
        transform=[
            ...
            dict(
                type="GridSample",
                grid_size=0.05,  # Adjusted grid size for WHU-MLS outdoor processing
                hash_type="fnv",
                mode="train",
    ...
    val=dict(
        ...
        transform=[
            ...
            dict(
                type="GridSample",
                grid_size=0.05,  # Match train validation grid scale
                hash_type="fnv",
                mode="train",
                return_grid_coord=True,
                return_inverse=True,
    ...
    test=dict(
        ...
        test_cfg=dict(
            voxelize=dict(
                type="GridSample",
                grid_size=0.05,  # Consistent 5cm tracking grid size for evaluation
                hash_type="fnv",
                mode="test",
                return_grid_coord=True,
            ),
